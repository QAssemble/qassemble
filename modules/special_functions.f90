...
lqnb
mtu0
mtu12 ( kf, kc, m, q, x, f1r, d1r, f2r, d2r )
othpl ( kf, n, x, pl, dpl )
pbdv ( v, x, dv, dp, pdf, pdd )
pbvv ( v, x, vv, vp, pvf, pvd )
pbwa ( a, x, w1f, w1d, w2f, w2d )
psi ( x, ps )
qstar ( m, n, c, ck, ck1, qs, qt )
rctj ( n, x, nm, rj, dj )
rcty ( n, x, nm, ry, dy )
refine ( kd, m, q, a, iflag )
rmn1 ( m, n, c, x, df, kd, r1f, r1d )
rmn2l ( m, n, c, x, df, kd, r2f, r2d, id )
rmn2so ( m, n, c, x, cv, df, kd, r2f, r2d )
rmn2sp ( m, n, c, x, cv, df, kd, r2f, r2d )
rswfo ( m, n, c, x, cv, kf, r1f, r1d, r2f, r2d )
rswfp ( m, n, c, x, cv, kf, r1f, r1d, r2f, r2d )
scka ( m, n, c, cv, kd, ck )
sckb ( m, n, c, df, ck )
sdmn ( m, n, c, cv, kd, df )
segv ( m, n, c, kd, cv, eg )
