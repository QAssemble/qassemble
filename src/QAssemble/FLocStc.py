...
#         matinv = np.zeros((norb,norb,ns),dtype=np.complex128)
...
#         Fnew = np.zeros((norb,norb,ns),dtype=np.complex128)

#         if iter == 1:
#             mix = 1.0
#             Fold = np.zeros((norb,norb,ns),dtype=np.complex128)
...
#         matloc = np.zeros((norb,norb,ns,nspace),dtype=np.complex128)
...
#         matout = np.zeros((norb,norb,ns,nrk),dtype=np.complex128)
...
#         eimp = np.zeros((norbc,norbc,ns,nspace),dtype=np.complex128)
...
#         U = np.zeros((norb,norb,ns,ns,nspace),dtype=np.complex128)
#         hloc = np.zeros((norbc,norbc,ns,nspace),dtype=np.complex128)
...
#         hdyn = np.zeros((norb,norb,ns,nft,nspace),dtype=np.complex128)
...
#         U = np.zeros((norb,norb,ns,ns,nspace),dtype=np.complex128)
#         floc = np.zeros((norbc,norbc,ns,nspace),dtype=np.complex128)
