...
#     #     fprojector = np.zeros((len(self.cry.find), self.forb, self.ns, self.nspace), dtype=np.float64)
#     #     bprojector = np.zeros((len(self.cry.bind), self.borb, self.ns, self.nspace), dtype=np.float64)
...
#         fpfl = np.zeros((nbndf[0], numwann[0], nk_loc, self.mpimanager.crystal.ns), dtype=np.complex128)
#         fplc = np.zeros((numwann[0], len(correlated), self.mpimanager.crystal.ns, self.nspace), dtype=np.complex128)
