...
#         matinv = np.zeros((norb,norb,ns,nft),dtype=np.complex128)
...
#         ftau = np.zeros((norb,norb,ns,ntau),dtype=np.complex128)
...
#         ff = np.zeros((norb,norb,ns,nfreq),dtype=np.complex128)
...
#         ynew = np.zeros((norb,norb,ns,nft),dtype=np.complex128)
...
#         Fnew = np.zeros((norb,norb,ns,nft),dtype=np.complex128)

#         if iter == 1:
#             mix = 1.0
#             Fold = np.zeros((norb,norb,ns,nft),dtype=np.complex128)
...
#         matloc = np.zeros((norb,norb,ns,nft,nspace),dtype=np.complex128)
...
#         matimp = np.zeros((norb,norb,ns,nft,nprob),dtype=np.complex128)
...
#         matout = np.zeros((norb,norb,ns,nfreq),dtype=np.complex128)
#         nind = np.amax(equiv)
...
#         matout = np.zeros((norb,norb,ns,nft),dtype=np.complex128)
...
#         sigmalocf = np.zeros((norbc,norbc,ns,nft,nspace),dtype=np.complex128)
