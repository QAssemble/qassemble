...
#         matout = np.zeros((norb,norb,ns,ns,nft),dtype=np.complex128)
...
#         btau = np.zeros((norb,norb,ns,ns,nft),dtype=np.complex128)
...
#         bf = np.zeros((norb,norb,ns,ns,nft),dtype=np.complex128)
...
#         ynew = np.zeros((norb,norb,ns,ns,nft),dtype=np.complex128)
...
#         Bnew = np.zeros((norb,norb,ns,ns,nft),dtype=np.complex128)

#         if iter == 1:
#             mix = 1.0
#             Bold = np.zeros((norb,norb,ns,ns,nft),dtype=np.complex128)
...
#         matloc = np.zeros((norb,norb,ns,ns,nft,nspace),dtype=np.complex128)
...
#         matimp = np.zeros((norb,norb,ns,ns,nft,nprob),dtype=np.complex128)
...
#         matout = np.zeros((norb,norb,ns,ns,nfreq),dtype=np.complex128)
#         nind = np.amax(equiv)
