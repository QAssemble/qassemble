...
FC = gfortran
INCLUDE = -I${DIAGE}/finufft/include
#FFLAGS = -debug -g -CB -check bounds -traceback -check uninit -fp-model precise
FFLAGS = -DMPI -lblas -llapack
LDFLAGS = # -L
LOADLIBES = ${DIAGE}/finufft/lib/libfinufft.so -lfftw3 -llapack
#LOADLIBES = ../finufft/lib/libfinufft.so -lfftw3 -mkl
LIBES = -L/opt/homebrew/opt/lapack/lib -llapack -lpthread -lm
...
fortran2python = f2py -c --fcompiler=intelem --compiler=intelem $(LOADLIBES) $(INCLUDE) $(FFTW)
