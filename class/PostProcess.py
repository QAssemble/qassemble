...
modpath = diage_path+"/modules"
sys.path.append(modpath)
import DiagE

class FPathDyn(object):

    def __init__(self, crystal : Crystal, ft : FT_grid, obj : object, kpath : list, nk : int):
        ...
        if (obj.__class__.__name__ is "GreenInt"):
            self.k = self.KArb(obj.grf,kpoint=self.kpath)
...
class BPathDyn(object):
    ...
    def __init__(self, crystal : Crystal = None, ft : FT_grid = None, obj : BLatDyn = None) -> object:
...
class BPathStc(object):
    ...
    def __init__(self, crystal : Crystal = None, obj : BLatStc = None) -> object:
