...
size = 1000
print("HF start")
func.HartreeFock(iter,mix,T,size,hopplist,onsitelist,option,V)
print("HF finish")
end = time.time()
delta = datetime.timedelta(seconds=(end-start))
print(f"HF loop time = {delta}")
energytest, eigvec = temp.Diagonalize(func.hamhf,True)
...
plt.savefig('validationG.png')
np.savetxt('band_diageG.dat',plot_band)
